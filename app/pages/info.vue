    ...
    <div class="p-0 m-0 mb-16 max-w-md mx-auto">
      ...
      <div class="prose prose-sm">
        <p>
          ...
          using <code>RGB</code>, which can go through kind of greyish colours.
          <code>Lab</code> interpolation produces better, more
          even&nbsp;results.
        </p>
        <p>
      ...
      <div class="prose prose-sm">
        ...
        <p>
          ...
          <a href="https://vis4.net/chromajs/">chroma.js</a> — and after
      ...
      <div class="prose prose-sm">
        <p>
          ...
          <a href="https://vis4.net/chromajs/">chroma.js</a> by
          Gregor&nbsp;Aisch.
        </p>
        <p>
          It uses <a href="https://tailwindcss.com/">Tailwind CSS</a> for most
          of the styling, with a few tweaks and custom&nbsp;styles.
        </p>
        <p>
          The text is set in <a href="https://rsms.me/inter/">Inter</a>,
          specifically the 400, 600, and 700&nbsp;weights.
        </p>
        <p>
          Comments & suggestions are very welcome! You can leave a message on
          <a href="https://twitter.com/stormwarning">Twitter</a> or file an
          issue on
